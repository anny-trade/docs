...
So let's prepare the Coinbase API keys and connect them to Anny.

## **Preparing Coinbase API keys**

In order to create an API it's necessary to have a Coinbase account.

A very important point in this step is to **create an exclusive API for Anny**.

To do this, log in to the Coinbase account and access your settings. Click on the 3 dots for "more" settings, scroll down and click on Advanced API.

Select the necessary key permissions to trade on Anny, which are "View" and "Trade".
